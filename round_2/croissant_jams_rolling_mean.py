...
# -*- coding: utf-8 -*-
"""
Created on Sun Apr 13 01:56:26 2025
...
class Trader:
    ...
    def run(self, state: TradingState):
        ...
        if z > self.z_entry:
            ...
            orders[Product.CROISSANTS].append(Order(Product.CROISSANTS, int(croissant_mid), -1 * qty)) #2
            orders[Product.JAMS].append(Order(Product.JAMS, int(jam_mid), 1 * qty)) #2
